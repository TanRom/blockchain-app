...
public class NNTCHAIN {
    ...
    public static CAIDATVI CAIDATVIA; //Ví A
    public static CAIDATVI CAIDATVIB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các ví
        CAIDATVIA = new CAIDATVI();
        CAIDATVIB = new CAIDATVI();
        CAIDATVI coinbase = new CAIDATVI();

        //Khởi tạo giao dịch gốc, để chuyển 100 Coin đến ví A CAIDATVIA
        genesisTransaction = new Transaction(coinbase.publicKey, CAIDATVIA.publicKey, 100f, null);
        ...
        System.out.println("\nSố dư của ví A là : " + CAIDATVIA.getBalance());
        System.out.println("\nGiao dịch chuyển số tiền là 40 từ ví A đến ví B...");
        block1.addTransaction(CAIDATVIA.sendFunds(CAIDATVIB.publicKey, 40f));
        addBlock(block1);
        System.out.println("\nSố dư mới của ví A là : " + CAIDATVIA.getBalance());
        System.out.println("Số dư của ví B là : " + CAIDATVIB.getBalance());

        Block block2 = new Block(block1.hash);
        System.out.println("\nVí A gửi một số tiền nhiều hơn số tiền có trong ví...");
        block2.addTransaction(CAIDATVIA.sendFunds(CAIDATVIB.publicKey, 1000f));
        addBlock(block2);
        System.out.println("\nSố dư mới của ví A là : " + CAIDATVIA.getBalance());
        System.out.println("Số dư mới của ví B là  " + CAIDATVIB.getBalance());

        Block block3 = new Block(block2.hash);
        System.out.println("\nGiao dịch chuyển số tiền là 20 từ ví B đến ví A...");
        block3.addTransaction(CAIDATVIB.sendFunds( CAIDATVIA.publicKey, 20));
        System.out.println("\nSố dư mới của ví A là : " + CAIDATVIA.getBalance());
        System.out.println("Số dư mới của ví B là  " + CAIDATVIB.getBalance());
